...
public class Parser extends Configurable {
  ...
  public void parse(Page page, String contextURL) throws NotAllowedContentException, ParseException {
    ...
    if (type == ContentType.BINARY) { // BINARY
    ...
    } else if (type == ContentType.XML) { // XML
      try {
    ...
    } else if (type == ContentType.TEXT) { // plain Text
      try {
    ...
    } else if (type == ContentType.HTML) { // isHTML
      ...
      // When a page contains a <meta name="fragment" content="!"> tag,
      // this indicates
      // that the page content is loaded through AJAX and a crawler that
      // does not
      // parse Javascript should request the same page with
      // _escaped_fragment_=
